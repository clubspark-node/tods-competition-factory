...
See [tieFormats](./tieFormat) for the format definition structure and the [tieFormat Governor](../governors/tie-format-governor) for methods to create, modify, and manage tieFormats.
